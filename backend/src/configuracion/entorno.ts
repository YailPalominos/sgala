...
function cargarEntorno(): Entorno {
  return {
    ...
    SQL_CONTRASENA: process.env.SGALA_SQL_CONTRASENA || '',
    SQL_BASE_DATOS: process.env.SGALA_SQL_BASE_DATOS || 'sgala',
    SQL_PUERTO: parseInt(process.env.SGALA_SQL_PUERTO || '3306', 10),
    ...
    SMTP_PUERTO: parseInt(process.env.SGALA_SMTP_PUERTO || '587', 10),
